...
const ticket = computed(() => ({
  id: event.value?.id,
  name: event.value?.event_name || 'Event Ticket',
  price: ticketPrice.value,
  qty: ticketQuantity.value
}))
...
const paymentMethods = [
  {
    id: 'quidly',
    label: 'Pay securely with Quidly',
    icon: '💳'
  }
]
...
//   }
  ...
  try {
    ...
    const returnUrl =
      `${window.location.origin}/checkout/${event.value.id}?payment_return=true`
    ...
    const payload = {
      ...
      amount: event.value.ticket_price,
    ...
    console.log(
      'Sending payment initialization:',
      payload
    )
    ...
    // This is where the actual Quidly widget opens
...
function handlePaymentReturn() {
   ...
   *
   * The return URL only means the customer returned
   * from the widget.
   *
   * The transaction should be verified using the backend
   * or webhook before tickets are issued.
   */
...
<template>
  <main
    class="min-h-screen bg-gray-50 px-4 py-8 sm:px-6 lg:px-8"
  >
    <div class="mx-auto max-w-6xl">
      ...
      <div
        class="grid gap-8 lg:grid-cols-[1.5fr_0.8fr]"
      >
        ...
        >
          ...
          >
            ...
            <div
              class="mx-4 h-px flex-1 bg-gray-200"
            ></div>
          ...
          >
            ...
            >
              ...
              <!-- Header -->
              <div
                class="bg-gradient-to-br from-purple-700 via-blue-700 to-cyan-600 px-6 py-7 text-white"
              >
              ...
              <div class="bg-white p-6">
                ...
                <!-- Security -->
                <div
                  class="mt-6 flex items-center gap-3 rounded-xl bg-gray-50 p-4"
                >
                  ...
                  >
                    ...
                    handled by the Quidly Payment Widget.
                    Card details are not entered on this
                    ticketing platform.
                  </p>
                ...
                >
                  ...
                  <span>
                    {{
                      loadingPayment
                        ? 'Initializing Quidly...'
                        : `Pay ${formatCurrency(total)} with Quidly`
                    }}
                  </span>
          ...
          <div
            v-else-if="checkoutStep === 'processing'"
          ...
          >
            ...
            <h2
              class="mt-7 text-xl font-bold text-gray-900"
            >
              Processing payment
            </h2>
            ...
            <p
              v-if="transactionId"
              class="mx-auto mt-5 max-w-md text-xs text-gray-400"
            >
              Transaction:
              {{ transactionId }}
            </p>
          ...
          >
            ...
            <p
              class="mx-auto mt-3 max-w-md text-gray-500"
            >
          ...
          <div
            v-else-if="checkoutStep === 'cancelled'"
            class="py-12 text-center"
          >
            ...
            <p
              class="mx-auto mt-3 max-w-md text-gray-500"
            >
              Your payment wasn't completed, and no
              money was charged.
            </p>

            <div
              class="mx-auto mt-8 flex max-w-md flex-col gap-3 sm:flex-row sm:justify-center"
            >
...
>
  ...
  <p class="mt-1 text-sm text-gray-500">
    {{ formatEventDate(event.event_date) }}
          ...
          <div
            class="my-6 border-t border-dashed border-gray-300"
          ></div>
